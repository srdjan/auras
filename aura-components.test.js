...
const { registerAuraComponents } = await import("./packages/components/mod.ts");
...
Deno.test("master-detail falls back to the first valid item when the initial value is invalid", () => {
...
Deno.test("master-detail clicking a trigger updates selection and dispatches aura-change", () => {
...
Deno.test("master-detail reselecting the active item does not dispatch aura-change", () => {
...
Deno.test("master-detail auto activation changes selection on arrow navigation", () => {
  const { host, triggers } = renderMasterDetail('value="elements"');
  const changes = [];
...
Deno.test("master-detail manual activation moves focus first and activates on Enter or Space", () => {
...
Deno.test("master-detail invalid activation values normalize back to auto", () => {
...
Deno.test("tabs fall back to the first valid tab and apply tab semantics", () => {
...
Deno.test("tabs clicking a trigger updates selection and dispatches aura-change", () => {
...
Deno.test("tabs auto activation changes selection on horizontal arrow navigation", () => {
...
Deno.test("tabs manual activation moves focus first and activates on Enter or Space", () => {
